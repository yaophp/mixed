...
use Think\Model;
class OrderTradeModel extends Model{
    ...
    protected $_field = "o.id,trade_number,detail,price,payment,status,o.time_create,time_update,time_expire,u.email,u2.email as uemail";
